...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUserName = intent.getStringExtra(Constants.USER_NAME)  // retrieve and store username
        ...
        mQuestionsList = Constants.getQuestions()     //  Return the added questions
    ...
    private fun setQuestion() {
        ...
        defaultOptionsView()  // reset the selected option

        var questions: Question = mQuestionsList!![mCurrentPosition - 1]
